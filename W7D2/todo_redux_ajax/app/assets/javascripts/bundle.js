...
var _todo_api_util = __webpack_require__(175);
...
var _todo_actions = __webpack_require__(21);
...
var _thunk = __webpack_require__(176);
...
var _root_reducer = __webpack_require__(88);
...
var configureStore = function configureStore() {
  return (0, _redux.createStore)(_root_reducer2.default, { todos: {} }, (0, _redux.applyMiddleware)(_thunk2.default));
};
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(20), __webpack_require__(83)(module)))
...
var _todos_reducer = __webpack_require__(89);
...
var _merge2 = __webpack_require__(90);
...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    case _todo_actions.RECEIVE_TODOS:
      ...
      (0, _merge3.default)(newState, state, newObject);
      return newState;
    case _todo_actions.RECEIVE_TODO:
      newState[action.todo.id] = action.todo;
      return (0, _merge3.default)({}, state, _defineProperty({}, action.todo.id, action.todo));
    default:
      return state;
  }
};
